  ...
  return (
    <div className="w-full pb-32">
      ...
      <div className="flex flex-col xl:flex-row gap-0 mt-0">
        ...
        {/* Vänster kolumn: Metadata (Sidofält) */}
          ...
          <div className="p-8 lg:p-12 max-w-[1500px] ml-0 mt-10 w-full">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-12 gap-10 mb-20 items-start">
               ...
               <div className="xl:col-span-4 space-y-6">
                  ...
                  <div className="bg-white rounded-[24px] overflow-hidden shadow-2xl border border-gray-100 group max-w-[380px] mx-auto xl:mx-0">
